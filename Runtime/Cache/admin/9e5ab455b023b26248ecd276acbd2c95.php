...
<div id="man_zone">
   ...
   <tr>
     <td colspan="6" height="30" align="center"> <a href="__URL__/control/model/<?php echo ($model); ?>/method/add">新增</a></td>
   </tr>
<?php switch($model): case "team": ?><div id="checkbox">
   <tr>
      ...
      <td width="20%" class="right_title_1">&nbsp;<?php echo L('PIC'); ?></td>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><tr>
       ...
       <td width="20%" class="right_title_1">&nbsp;<a href="__URL__/control/model/<?php echo ($model); ?>/id/<?php echo ($vo["id"]); ?>/method/edit"><?php echo L('EDIT'); ?></td> 
    </tr><?php endif; ?>
    <?php if(($mod) == "1"): ?><tr>
       <td width="10%" class="right_title_1"><input type="checkbox" name="id" id="id" value="<?php echo ($vo["id"]); ?>" /></td>
       <td width="10%" class="right_title_1"><?php echo ($vo["id"]); ?></td>
  ...
  <?php case "client": ?><div id="checkbox">
   <tr>
      <td width="10%" class="right_title_1"></td>
      <td width="10%" class="right_title_1"><?php echo L('ID'); ?>&nbsp;</td>
      <td width="20%" class="right_title_1">&nbsp;<?php echo L('IDNAME'); ?></td>
   ...
   <tr>
    <td colspan="6" class="right_title_2" height="50"><form  id="del" method="post"> 删除作品：&nbsp;否&nbsp;<input type="radio" name="del" value="false" checked="checked"  />&nbsp;是<input type="radio" name="del" value="true"  />&nbsp;&nbsp;<input type="submit" class="submit" value=""  />&nbsp;&nbsp;<font style="color:red">(*删除*)</font>  </form></td>
   </tr>
  </table>
</div>
...
$(document).ready(function(){
	var module="<?php echo $model;?>";
	$("#del").delList("__GROUP__/Company/_list/model/"+module,"__GROUP__/Company/del",module);
});
</script>
</body>
</html>