...
<div id="man_zone">
   ...
   <tr>
     <td colspan="6" height="30" align="center"> <a href="__URL__/sortcontrol/method/add">增加分类</a></td>
   </tr>
   <div id="checkbox">
   <tr>
      <td width="10%" class="right_title_1"></td>
      <td width="10%" class="right_title_1"><?php echo L('ID'); ?>&nbsp;</td>
      <td width="30%" class="right_title_1">&nbsp;<?php echo L('IDNAME'); ?></td>
      <td width="30%" class="right_title_1">&nbsp;<?php echo L('ENGLISH'); ?></td>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><tr>
       ...
       <td width="30%" class="right_title_2"><?php echo ($vo["name"]); ?></td>
       <td width="30%" class="right_title_2"><?php echo ($vo["ename"]); ?></td>
       <td width="20%" class="right_title_2">&nbsp;<a href="__URL__/sortcontrol/id/<?php echo ($vo["id"]); ?>/method/edit"><?php echo L('EDIT'); ?></td> 
    </tr><?php endif; ?>
    <?php if(($mod) == "1"): ?><tr>
       ...
       <td width="30%" class="right_title_1"><?php echo ($vo["name"]); ?></td>
       <td width="30%" class="right_title_1"><?php echo ($vo["ename"]); ?></td>
       <td width="20%" class="right_title_1">&nbsp;<a href="__URL__/sortcontrol/id/<?php echo ($vo["id"]); ?>/method/edit"> <?php echo L('EDIT'); ?></td> 
...
$(document).ready(function(){
	var module="procates"
	$("#del").delList("__URL__/prosort","__URL__/del",module);
});
</script>
</body>
</html>