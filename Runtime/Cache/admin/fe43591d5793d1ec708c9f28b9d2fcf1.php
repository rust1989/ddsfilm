...
<div id="man_zone">
   ...
   <form method="post" action="__URL__/saveteam" enctype="multipart/form-data" onsubmit="editor.sync();">
   ...
   <tr>
    ...
    <tr>
      ...
      <td width="60%" ><input type="text" name="weibo" /></td>
    </tr>
    
    <tr>
      <td width="40%" class="left_title_2"><?php echo L('INFOR');?>:</td>
      <td width="60%" ><input type="text" name="infor"  /></td>
    </tr>
