...
<div id="man_zone">
   ...
   <tr>
     <td colspan="6" height="30" align="center"> <a href="__URL__/addteam">增加导演</a></td>
   </tr>
   <div id="checkbox">
   <tr>
    ...
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($mod) == "0"): ?><tr>
       ...
       <td width="20%" class="right_title_1">&nbsp;<a href="__URL__/editteam/id/<?php echo ($vo["id"]); ?>"><?php echo L('EDIT'); ?></td> 
    </tr><?php endif; ?>
    <?php if(($mod) == "1"): ?><tr>
       <td width="10%" class="right_title_1"><input type="checkbox" name="id" id="id" value="<?php echo ($vo["id"]); ?>" /></td>
       <td width="10%" class="right_title_1"><?php echo ($vo["id"]); ?></td>
       <td width="20%" class="right_title_1"><?php echo ($vo["name"]); ?></td>
       <td width="20%" class="right_title_1"><img src="<?php echo ($vo["pic"]); ?>" height="100" width="100" /></td>
       <td width="20%" class="right_title_1"><?php echo ($vo["infor"]); ?></td>
       <td width="20%" class="right_title_1">&nbsp;<a href="__URL__/editteam/id/<?php echo ($vo["id"]); ?>"><?php echo L('LIST'); ?></td> 
