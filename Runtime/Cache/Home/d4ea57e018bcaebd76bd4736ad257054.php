...
<div id="icon">
 <ul><li><a href="javascript:void(0);"><img src="__IMG__/picon.jpg"></a></li><li><a href="javascript:void(0);"><img src="__IMG__/wicon.png"></a></li></ul>
</div>
<header>
  <div id="title">
        ...
        <div id="top-navigation">	
                <ul class="menu" id="menu-top-navigation">
                    ...
                    <li class="menu-item parent-item">
                        ...
                        <ul class="sub-menu">
                          <?php if(is_array($procates)): $i = 0; $__LIST__ = $procates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i == 1): ?><li class=" first cmenu-item">
...
$("document").ready(function(){
	...
	*/
	...
	function changeposition(){
		...
		$("#title,#navTop li,#navTop").removeAttr('style');
	   if(browwd<320){
		 wid=1;
		 browwd=380;
		 twid=0.7;  
	   }else if(320<=browwd&browwd<480){
		wid=1;
		twid=0.7;  
		$("#navTop,#top-navigation").css({'float':'left','width':'100%'});
		$("#title,#navTop li").css({'width':'100%'});
	   }else if(481<browwd&browwd<800){
		wid=0.5;
		twid=0.8;
	 ...
	 /* $("#title").css({'width':237*twid});
	  $("#title img").css({'width':178*twid,'height':60*twid});
	  $("#navTop li a").css({'width':140*twid}); 
	  $(".parent-item").css({'width':145*twid}); 
	  $("#icon").css({'width':90*twid});
	  $("#icon img").css({'width':32*twid});*/
	  
	  $(".sub-menu").css({'width':browwd-100,'overflow':'hidden'});
